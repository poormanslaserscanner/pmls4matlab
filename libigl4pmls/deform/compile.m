...
mex( ...
  ...
  'deform.cpp', 'libiomp5md.lib');

%mex  -v -DEIGEN_CHOLMOD_SUPPORT -DEIGEN_UMFPACK_SUPPORT -DEIGEN_METIS_SUPPORT -DEIGEN_SPQR_SUPPORT deform.cpp -Id:/pmlsgit/git_pmls4matlab/pmls4matlab/libigl4pmls/libigl/include -Id:/pmlsgit/git_iso2mesh_bin/install/Eigen/include/eigen3
